 ...
 * Barcode Detector.
 */
public class BarcodeScannerProcessor2 extends VisionProcessorBase<List<Barcode>> {
    ...
    public BarcodeScannerProcessor2(Context context) {
        super(context);
    ...
    protected void onSuccess(
        ...
        for (int i = 0; i < barcodes.size(); ++i) {
            ...
            if (barcode != null && barcode.getRawValue() != null && !barcode.getRawValue().isEmpty()) {
                new ScannedResult().getInstance().setCode(barcode.getRawValue());
            }
        }
    }
