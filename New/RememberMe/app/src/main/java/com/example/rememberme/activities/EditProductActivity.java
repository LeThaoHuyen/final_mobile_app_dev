...
public class EditProductActivity extends AppCompatActivity{
    ...
    Button btn_addOne, btn_cancel, btn_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_name = findViewById(R.id.edittext_product_name);
        et_expDate = findViewById(R.id.edittext_expiry_date);
        et_serialNum = findViewById(R.id.edittext_series_ID);
